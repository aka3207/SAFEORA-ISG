      ...
      <div className="container">
        ...
        <div className="grid grid-cols-3">
          {t.items.map((item, index) => {
            ...
            return (
              <div key={index} className="glass-card" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                <div style={{ width: '60px', height: '60px', background: 'var(--input-bg)', borderRadius: '15px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--primary)', border: '1px solid var(--border)' }}>
                  <Icon size={32} />
                </div>
                <div>
